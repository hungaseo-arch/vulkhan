...
production 에 적재하고 확인까지 끝냈습니다.

| 확인 | 결과 |
|---|---|
| 월별 대사 `2026-08` | 58전표 / 405 EA / IDR 523,816,000 — 원본과 일치 |
| `SO-2608-%` 머리 / 품목 / 재고이동 | 58 / 83 / 83 |
| CSV 대 DB 라인 대사 | 0행 (수량·단가까지 전부 일치) |

스테이징은 `\copy` 가 아니라 `00_staging_konsol.sql` 로 넣었습니다 —
Neon 콘솔에서 진행했기 때문입니다.
